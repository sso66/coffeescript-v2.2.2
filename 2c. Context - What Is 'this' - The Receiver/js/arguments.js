...
var cat, chooseMeals, ringFireAlarm, setName;
...
setName = function(name) { // no code required! but, can have issue with compiler?
  this.name = name;
};
...
ringFireAlarm = function(isDrill) {
  return isDrill != null ? isDrill : isDrill = true;
};
...
// Function Object
chooseMeals = function(breakfast = 'waffles', lunch = 'gyros', dinner = 'pizza') {
